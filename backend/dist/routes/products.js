...
router.get('/', async (req, res) => {
    try {
        const { page = '1', limit = '20', category, isHot, isNew, minPrice, maxPrice, search, sort = 'created_at', order = 'desc', } = req.query;
...
router.post('/', auth_1.authMiddleware, async (req, res) => {
    try {
        const { title, description, price, originalPrice, categoryId, images, specs, stock, isHot, isNew, tags, } = req.body;
        // 验证必填字段
